...
HD_PWD='C:/Users/TDC/Vivado/Project_17/Project_17.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log COUNTER_N_bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source COUNTER_N_bits.tcl -notrace
