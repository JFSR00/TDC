...
HD_PWD='C:/Users/TDC/Vivado/Project_17/Project_17.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log COUNTER_N_bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source COUNTER_N_bits.tcl
