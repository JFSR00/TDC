...
HD_PWD='C:/Users/TDC/Vivado/TDC/KNIGHT_RIDER/KNIGHT_RIDER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_EX00.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FSM_EX00.tcl -notrace
