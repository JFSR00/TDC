...
HD_PWD='C:/Users/TDC/Vivado/TDC/KNIGHT_RIDER/KNIGHT_RIDER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_EX00.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FSM_EX00.tcl
