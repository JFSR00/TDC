...
HD_PWD='C:/Users/TDC/Vivado/TDC/Project_23/Project_23.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_WF_ASYNC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RAM_WF_ASYNC.tcl -notrace
