...
HD_PWD='C:/Users/TDC/Vivado/TDC/Project_23/Project_23.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_WF_ASYNC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_WF_ASYNC.tcl
