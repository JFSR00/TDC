...
HD_PWD='C:/Users/TDC/Vivado/project_20/project_20.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PRESCALER_1Hz.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PRESCALER_1Hz.tcl -notrace
