...
HD_PWD='C:/Users/TDC/Vivado/project_20/project_20.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PRESCALER_1Hz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PRESCALER_1Hz.tcl
