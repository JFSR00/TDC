...
HD_PWD='C:/Users/TDC/Vivado/Project_18/Project_18.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log YOUR_TURN.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source YOUR_TURN.tcl -notrace
