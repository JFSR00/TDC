...
HD_PWD='C:/Users/TDC/Vivado/Project_18/Project_18.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log YOUR_TURN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source YOUR_TURN.tcl
