...
HD_PWD='C:/Users/TDC/Vivado/Project_08/Project_08.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DISP7SEG.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DISP7SEG.tcl -notrace
