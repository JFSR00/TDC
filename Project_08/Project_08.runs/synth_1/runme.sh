...
HD_PWD='C:/Users/TDC/Vivado/Project_08/Project_08.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DISP7SEG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DISP7SEG.tcl
