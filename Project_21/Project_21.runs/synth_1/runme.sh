...
HD_PWD='C:/Users/TDC/Vivado/Project_21/Project_21.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DISP7SEG_8ON.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DISP7SEG_8ON.tcl
