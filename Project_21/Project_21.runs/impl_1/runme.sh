...
HD_PWD='C:/Users/TDC/Vivado/Project_21/Project_21.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DISP7SEG_8ON.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DISP7SEG_8ON.tcl -notrace
