...
HD_PWD='C:/Users/TDC/Vivado/TDC/Project_25/Project_25.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_16x4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ROM_16x4.tcl -notrace
